...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-any-by/tags). For example,

```javascript
anyBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-any-by@v0.1.0-umd/browser.js' )
```
